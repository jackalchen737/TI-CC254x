...
extern uint8 Application_StartAdvertise(uint16 duration, uint16 interval);
extern uint8 Application_StopAdvertise();

#ifdef PLUS_OBSERVER
extern void startObserving();
extern void listObserving();
#endif
